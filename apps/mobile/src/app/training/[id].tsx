...
const styles = StyleSheet.create({
  ...
  title: { color: "#111111", fontSize: 27, fontWeight: "900", marginTop: 6 },
  clock: { color: "#111111", fontSize: 24, fontWeight: "900" },
  progressTrack: {
    height: 8,
    borderRadius: 4,
  ...
  progressLabel: { color: "#666666", fontSize: 11, marginTop: 7 },
  pauseButton: {
    alignItems: "center",
    borderWidth: 1,
    borderColor: "#222222",
  ...
  pauseButtonText: { color: "#222222", fontWeight: "900" },
  pausedCard: {
    borderRadius: 14,
  ...
  currentTitle: { color: "#111111", fontSize: 30, fontWeight: "900" },
  ...
  timerLabel: { color: "#555555", fontSize: 12, fontWeight: "800" },
  timer: {
    color: "#111111",
    fontSize: 48,
    fontWeight: "900",
  ...
  secondaryButtonText: { color: "#222222", fontWeight: "900" },
  textButton: { padding: 7 },
  textButtonText: { color: "#555555", fontSize: 12, fontWeight: "800" },
  skipButton: { alignItems: "center", padding: 10 },
  skipText: { color: "#666666", fontSize: 12, fontWeight: "800" },
  disabledButton: { opacity: 0.3 },
  message: { color: "#9b1c1c", fontSize: 13, lineHeight: 20, marginTop: 12 },
  queue: {
    borderTopWidth: 1,
  ...
  queueSection: { gap: 8 },
  queueSectionName: { color: "#555555", fontSize: 12, fontWeight: "900" },
  queueItem: { flexDirection: "row", alignItems: "center", gap: 9 },
  queueMark: { width: 18, color: "#333333", fontWeight: "900" },
  queueTitle: { color: "#333333", fontSize: 13 },
  dangerButton: {
    alignItems: "center",
    borderWidth: 1,
    borderColor: "#c8a0a0",
  ...
  dangerText: { color: "#9b1c1c", fontSize: 12, fontWeight: "900" },
  summaryContent: {
    width: "100%",
    maxWidth: 620,
    alignSelf: "center",
  ...
  summaryTitle: { color: "#111111", fontSize: 38, fontWeight: "900" },
  summaryGrid: {
    flexDirection: "row",
    borderWidth: 1,
    borderColor: "#dddddd",
  ...
  summaryValue: { color: "#111111", fontSize: 20, fontWeight: "900" },
});
